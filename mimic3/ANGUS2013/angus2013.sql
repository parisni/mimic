...
--END - CHAP 2 TISSU_PERF | HADM = 22708

--BEGIN - CHAP 3 INFLA VARS
...
--END - CHAP 3 INFLA VARS | HADM = 33569


--BEGIN - CHAP 4 HEMO_VARS
...
--END - CHAP 4 HEMO_VARS | HADM = 44579
...
INSERT INTO organ_dysf (subject_id, hadm_id) (
	...
	mimiciii.chartevents ce
    WHERE
	((ce.subject_id, ce.hadm_id) IN (SELECT subject_id, hadm_id FROM arterial_hypox)) OR
	...
	( ce.itemid IN ( 4948, 225651, 225690 ) AND uom ILIKE 'mg/dL' AND ce.valuenum > 4) -- BILLIRUBIN !! il faut aussi traduire d'autres unités
