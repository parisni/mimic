...
SELECT ev.ITEMID,
       ...
       COUNT(ev.ITEMID)
FROM chartevents ev
JOIN D_ITEMS di ON di.ITEMID = ev.ITEMID 
WHERE di.ITEMID IN(SELECT ITEMID FROM D_ITEMS WHERE lower(LABEL) LIKE '%o2%')
...
FROM chartevents ev
JOIN D_ITEMS di ON di.ITEMID = ev.ITEMID 
WHERE di.ITEMID IN(SELECT ITEMID FROM D_ITEMS WHERE lower(LABEL) LIKE '%pao2%')
GROUP BY ev.ITEMID, di.LABEL
ORDER BY COUNT(ev.ITEMID) DESC
)
...
FROM chartevents ev
JOIN D_ITEMS di ON di.ITEMID = ev.ITEMID 
WHERE di.ITEMID IN(SELECT ITEMID FROM D_ITEMS WHERE lower(LABEL) LIKE '%mean%')
GROUP BY ev.ITEMID, di.LABEL
ORDER BY COUNT(ev.ITEMID) DESC
)
...
SELECT ev.ITEMID,
       di.LABEL,
       COUNT(ev.ITEMID)
--FROM procedureevents ev
--FROM chartevents ev
--FROM MEDEVENTS ev
FROM LABEVENTS ev
--FROM IOEVENTS ev
--FROM ICUSTAYEVENTS ev
--FROM CENSUSEVENTS ev
JOIN D_ITEMS di ON di.ITEMID = ev.ITEMID 
WHERE di.ITEMID IN(SELECT ITEMID FROM D_ITEMS WHERE lower(LABEL) LIKE '%bil%')
GROUP BY ev.ITEMID, di.LABEL
ORDER BY COUNT(ev.ITEMID) DESC
)
...
--FROM CENSUSEVENTS ev
JOIN D_ITEMS di ON di.ITEMID = ev.ITEMID 
WHERE di.ITEMID IN(SELECT ITEMID FROM D_ITEMS WHERE lower(LABEL) LIKE '%pla%')
GROUP BY ev.ITEMID, di.LABEL
ORDER BY COUNT(ev.ITEMID) DESC
)
...
--FROM CENSUSEVENTS ev
JOIN D_ITEMS di ON di.ITEMID = ev.ITEMID 
WHERE di.ITEMID IN(SELECT ITEMID FROM D_ITEMS WHERE lower(LABEL) LIKE '%crea%')
GROUP BY ev.ITEMID, di.LABEL
ORDER BY COUNT(ev.ITEMID) DESC
)
...
--FROM CENSUSEVENTS ev
JOIN D_ITEMS di ON di.ITEMID = ev.ITEMID 
WHERE di.ITEMID IN(SELECT ITEMID FROM D_ITEMS WHERE lower(LABEL) LIKE '%gcs%')
GROUP BY ev.ITEMID, di.LABEL, di.dbsource
ORDER BY COUNT(ev.ITEMID) DESC
)
--198 GCS Total
SELECT * FROM coma;
